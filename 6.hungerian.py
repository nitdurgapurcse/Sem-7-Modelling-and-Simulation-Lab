...
Enter values for row 1 separated by spaces: 13 8 16 18 19
Enter values for row 2 separated by spaces: 9 15 24 9 12
Enter values for row 3 separated by spaces: 12 9 4 4 4
Enter values for row 4 separated by spaces: 6 12 10 8 13
Enter values for row 5 separated by spaces: 15 17 18 12 20
Linear Assignment problem result: 42
[['X' '8' 'X' 'X' 'X']
 ['X' 'X' 'X' 'X' '1']
 ['X' 'X' '4' 'X' 'X']
 ['6' 'X' 'X' 'X' 'X']
